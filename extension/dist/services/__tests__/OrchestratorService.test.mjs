...
describe('OrchestratorService (ESM)', () => {
    ...
    beforeEach(() => {
        ...
        orchestrator = new OrchestratorService(config, retrieval, inference, memory, telemetry, meta, planner, coder, critic, tester);
    ...
    test('should execute the full workflow and return results on happy path', async () => {
        ...
        jest.spyOn(meta, 'runReflexion').mockResolvedValue({ summary: '' });
